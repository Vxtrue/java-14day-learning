# Calculator
**Level:** 🟩 Basics  
**Concepts:** variables, methods, conditionals, input validation, exceptions

A tiny CLI calculator that performs `+  -  *  /` and demonstrates **clean methods**, **input validation**, and **safe divide-by-zero handling**.
...
1. Open the project.
2. Run the `Calculator` class (green ▶ next to `main`).
